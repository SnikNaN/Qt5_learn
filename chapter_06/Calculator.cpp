...
Calculator::Calculator(QWidget* pwgt/*= 0*/) : QWidget(pwgt)
{
    ...
    ptopLayout->addLayout(m_pvbxLayout, 6, 0, 1, 4);
    m_pvbxLayout->setSpacing(20);
    m_pvbxLayout->setAlignment(Qt::AlignRight);
...
void Calculator::calculate()
{
    ...
    QLabel* lbl = new QLabel(QString::number(fResult));

    m_pvbxLayout->addWidget(lbl);
}
